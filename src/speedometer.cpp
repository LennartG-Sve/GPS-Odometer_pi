...
OdometerInstrument_Speedometer::OdometerInstrument_Speedometer( wxWindow *parent, wxWindowID id, wxString title, int cap_flag,
    int s_value, int e_value) : OdometerInstrument_Dial( parent, id, title, cap_flag, 225, 270, s_value, e_value) {
