...
void OdometerInstrument_Dial::SetOptionMarker(double step, DialMarkerOption option, int offset) { 
	m_MarkerStep = step; 
	m_MarkerOption = option; 
	m_MarkerOffset = offset; 
}

void OdometerInstrument_Dial::SetOptionLabel(double step, DialLabelOption option, wxArrayString labels) { 
	m_LabelStep = step; 
	m_LabelOption = option; 
	m_LabelArray = labels;
}

void OdometerInstrument_Dial::SetOptionMainValue(wxString format, DialPositionOption option) {
	m_MainValueFormat = format; 
	m_MainValueOption = option;
}

void OdometerInstrument_Dial::SetOptionExtraValue(int cap, wxString format, DialPositionOption option) {
	m_ExtraValueCap = cap; 
	m_cap_flag |= cap; 
...
void OdometerInstrument_Dial::DrawFrame(wxGCDC* dc) {
    wxSize size = GetClientSize();
    wxColour cl;
...
void OdometerInstrument_Dial::DrawMarkers(wxGCDC* dc) {
...
void OdometerInstrument_Dial::DrawLabels(wxGCDC* dc)
{
...
void OdometerInstrument_Dial::DrawBackground(wxGCDC* dc) {
      // Nothing to do here right now, will be overwritten
      // by child classes if required
}

void OdometerInstrument_Dial::DrawData(wxGCDC* dc, double value,
...
void OdometerInstrument_Dial::DrawForeground(wxGCDC* dc) {
