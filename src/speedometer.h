...
//
// CLASS:
//    OdometerInstrument_Speedometer
//
// DESCRIPTION:
//    This class creates a speedometer style control
//
//
class OdometerInstrument_Speedometer: public OdometerInstrument_Dial {
public:
	OdometerInstrument_Speedometer(wxWindow *parent, wxWindowID id, wxString title, int cap_flag, int s_value, int e_value);
	~OdometerInstrument_Speedometer(void);
